...
public class MiniPID2903 extends Subsystem {
	 ...
	 */
	public MiniPID2903(double p, double i, double d) {
		P = p;
		I = i;
		D = d;
		checkSigns();
	 ...
	 */
	public MiniPID2903(double p, double i, double d, double f) {
		P = p;
		I = i;
		D = d;
		F = f;
	 ...
	 * 
	 * @see MiniPID2903#getOutput(actual) <br>
	 * @param setpoint
	 */
